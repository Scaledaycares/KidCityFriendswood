...
function sendInputToGAS3(message, isUserMessage) {
    const GAS_URL3 = 'https://script.google.com/macros/s/AKfycbylKHVBIQTdhyMWZIHqmBtw5-WNneQnNppIN7a6YiLUlclsVQjRXdNfq3OzTH97PiO-3A/exec'; // Replace with your actual URL
...
function startConversation() {
    fetch('https://chatbot-for-kids-city-usa-friendswood-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-kids-city-usa-friendswood-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGAS(message, isUserMessage) {
    var GAS_URL = 'https://script.google.com/macros/s/AKfycbyoIAqS4InR2jxpb25U6qE6fW7ea6Gv0Y9nK5xitYPP_q0nmR2Pe2Xb8IGbjLvzA9TqPA/exec';
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbwiELUVYw1FxWtGNTNusypznp8mDXJ0x9LgYhs14vwR-_u3sJbO4ah9yVe44ZicAH8onA/exec';
